(function (n) {
  function t(t) {
    for (
      var r, i, l = t[0], s = t[1], c = t[2], u = 0, h = [];
      u < l.length;
      u++
    )
  ...
  (l.e = function (n) {
    ...
    (l.c = r),
    (l.d = function (n, t, e) {
      l.o(n, t) || Object.defineProperty(n, t, { enumerable: !0, get: e });
    }),
    (l.r = function (n) {
  ...
  "56d7": function (n, t, e) {
    ...
    var s = {
      ...
      c = {
        ...
        fontFamily:
          '"SF UI Text", "Helvetica Neue", "Segoe UI", "Oxygen",\n    "Ubuntu", "Cantarell", "Open Sans", sans-serif',
      },
      u = c,
      d = "section-nav",
      h = "nav-bullet",
      ...
      A = function (n, t) {
        return function () {
          ...
          return Object(a["b"])(
            ...
            D(n),
            D(t),
            a["b"].apply(void 0, Object(E["a"])(r || ""))
          );
        };
      },
      $ = { between: A, maxWidth: H, minWidth: I, breakpoints: B };
    function R(n, t) {
    ...
    var Y = Object(C["f"])() ? "https://" + location.host : "";
    function G() {
      return V() ? "http://localhost:" + P["SHELF_PORT"] : Y + "/shelf";
    }
    function J() {
    ...
    function K(n, t) {
      ...
      if (e) {
        ...
        "next" == r ? (e = f(1)) : "previous" == r && (e = f(-1)),
          e &&
            (setTimeout(function () {
              e.classList.add("scrolled");
            }, 1e3),
            a ? Z(e.offsetTop) : scrollTo(0, e.offsetTop),
            setTimeout(function () {
    ...
    function Z(n) {
      var t =
        ...
        o = X() ? 3 * t : t,
        a = Math.max(0.1, Math.min(Math.abs(r - n) / o, 0.8)),
        i = function (n) {
          return (n /= 0.5) < 1
            ? 0.5 * Math.pow(n, 3)
            : 0.5 * (Math.pow(n - 2, 3) + 2);
        };
      function l() {
        e += 1 / 60;
        var t = e / a,
          o = i(t);
        t < 1
          ? (requestAnimationFrame(l), scrollTo(0, r + (n - r) * o))
          : scrollTo(0, n);
      }
      l();
    }
    ...
    Object(a["d"])(
      ...
      $.minWidth(">medium")(un()),
      $.maxWidth("medium")(cn()),
      $.between(">medium", "1600px")(sn()),
      $.minWidth("1601px")(ln()),
      $.maxWidth("medium")(an()),
      ".".concat(f),
      $.maxWidth("portrait")(on(), s.lime),
      s.electricBlue,
      s.lime,
      d,
      d,
      $.minWidth(">medium")(
        rn(),
        N("rgba(163, 204, 170, 0.3)"),
        s.electricBlue,
        d,
        s.lime
      ),
      $.maxWidth("portrait")(en(), s.lime),
      $.minWidth(">medium")(tn()),
      $.minWidth(">medium")(
        nn(),
        p,
        "button:not([disabled]):not(.".concat(h, ")")
      )
    );
    var hn = o["a"].component("Announcer", {
      ...
      Mn = function () {
        var n = this,
          t = n.$createElement,
          e = n._self._c || t;
        return "string" === typeof n.url
          ? e(
              "StyledButtonLink",
              {
                staticClass: "sauce-button",
                attrs: { href: n.url, "data-theme": n.lime && "lime" },
              },
              [
                e(
                  "div",
                  ...
                  [
                    ...
                    n.noArrow
                      ? n._e()
                      : e("BowArrow", { staticClass: "bow-arrow" }),
                  ],
                  2
                ),
              ]
          ...
          : e(
              ...
              {
                staticClass: "sauce-button",
                attrs: { type: n.type, "data-theme": n.lime && "lime" },
              },
              [
                e(
                  "div",
    ...
    function kn(n, t) {
      var e = Object(a["b"])(
        ...
        u.colors.lime,
        u.colors.lime,
        u.colors.electricBlue,
        u.colors.electricBlue,
        u.colors.electricBlue
      );
      return On({ name: "StyledButton" }, Object(a["c"])(n, t)(yn(), e));
    }
    var jn = kn("a", {}),
      Sn = kn("button", {}),
      Cn = {
        components: { BowArrow: zn, StyledButton: Sn, StyledButtonLink: jn },
        props: {
          url: String,
          lime: { type: Boolean, default: !1 },
          type: { type: String, default: "button" },
          noArrow: { type: Boolean, default: !1 },
        },
      },
      Pn = Cn,
    ...
    var Dn = o["a"].component("Cavalier", {
        render: function () {
          ...
          return n(
            In,
            { attrs: { "data-theme": this.theme }, class: "cavalier" },
            [
              n("div", { class: "cavalier-content" }, [
                this.$slots.heading ||
                  (this.heading &&
                    n("h1", { domProps: { innerHTML: this.heading } })),
                this.$slots.text ||
                  (this.text && n("p", { domProps: { innerHTML: this.text } })),
    ...
    var Hn = Dn,
      An = function () {
        ...
        return e(
          ...
          [
            ...
            e("Button", { attrs: { type: "submit", id: "submit-button" } }, [
              n._v("\n    Shoot\n  "),
            ]),
          ],
          1
      ...
      Rn = function () {
        ...
        return e(
          "StyledInputGroup",
          {
            class: ["input-group", { focused: n.focused }],
            attrs: { "data-id": n.id },
          },
          [
            n.label
              ? e("label", { attrs: { for: n.id } }, [
                  n._v(" " + n._s(n.label)),
                ])
              : n._e(),
            n.textarea
                      ...
                      n._b(
                        {
                          ...
                          on: { blur: n.handleBlur, focus: n.handleFocus },
                        },
                        "textarea",
                        n.inputAttrs,
                        !1
      ...
      Yn = {
        ...
        methods: {
          handleFocus: function (n) {
            (this.focused = !0),
              this.listen &&
                "function" === typeof this.listen.focus &&
                this.listen.focus.call(this, n);
          },
          handleBlur: function (n) {
            (this.focused = !1),
              this.listen &&
                "function" === typeof this.listen.blur &&
                this.listen.blur.call(this, n);
          },
        },
        components: { StyledInputGroup: Vn },
        props: {
          label: String,
          listen: Object,
          name: String,
    ...
    var et = Object.assign(
        a["c"].form(
          tt(),
          $.maxWidth("portrait")(nt()),
          $.minWidth(">portrait")(Zn()),
          $.maxWidth("portrait")(Qn()),
          $.maxWidth("portrait")(Kn())
        ),
        { name: "StyledContactForm" }
      ),
      rt = {
        components: { StyledContactForm: et, InputGroup: Xn, Button: Ln },
      },
      ot = rt,
      ...
      lt = function () {
        ...
        return e(
          ...
          [
            n._t("default"),
            e("Announcer", {
              attrs: { message: n.announcement, readOut: n.readAnnouncement },
            }),
          ],
          2
        );
      ...
      ct = {
        ...
        props: {
          announcement: String,
          id: { type: String, required: !0 },
          readAnnouncement: { type: Boolean, default: !1 },
        },
      },
      ut = ct,
      ...
      ft = function () {
        ...
        return e(
          ...
          [
            e("div", { staticClass: "inner-content" }, [
              e(
                "div",
                { staticClass: "footer-main" },
                [e("ContactPortal.Basic"), e("CrossSiteNav")],
                1
              ),
              e(
                "div",
                ...
                [
                  e("span", [
                    n._v("© Olaolu Olawuyi " + n._s(new Date().getFullYear())),
                  ]),
                  e("ContactPortal.Social"),
                ],
                1
              ),
            ]),
      ...
      pt = function () {
        ...
        return n.isFooter
          ? e(
              "StyledFooter",
              { attrs: { "data-section": n.name, tabindex: n.isHome && "-1" } },
              [n._t("default")],
              2
            )
          : e(
              "StyledSection",
              { attrs: { "data-section": n.name, tabindex: "-1" } },
              [n._t("default")],
              2
            );
      },
    ...
    function zt(n) {
      for (var t = 1; t < arguments.length; t++) {
        var e = null != arguments[t] ? arguments[t] : {};
        t % 2
          ? bt(e, !0).forEach(function (t) {
              Object(S["a"])(n, t, e[t]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(e))
          : bt(e).forEach(function (t) {
              Object.defineProperty(
                n,
                t,
                Object.getOwnPropertyDescriptor(e, t)
    ...
    function Et() {
      var n =
        ...
        e = Object(a["b"])(
          Pt(),
          $.maxWidth("portrait")(Ct()),
          $.between(">portrait", "medium")(St()),
          $.minWidth(">medium")(jt()),
          $.minWidth(">medium")(kt()),
          $.minWidth(">mediium")(xt()),
          $.maxWidth("portrait")(Ot()),
          $.between(">portrait", "medium")(_t()),
          $.minWidth(">medium")(yt()),
          $.between(">medium", "xLarge")(wt()),
          $.minWidth(">xLarge")(Mt())
        );
      return zt({ name: "StyledSection" }, Object(a["c"])(n, t)(gt(), e));
    }
    var Lt = Et(),
      Ft = Et("footer"),
      Tt = {
        components: { StyledSection: Lt, StyledFooter: Ft },
        props: {
          name: { type: String, required: !0 },
          isFooter: { default: !1, type: Boolean },
        },
      },
      Wt = Tt,
    ...
    var Qt = Object(a["b"])(
      ...
      Zt = Object.assign(
        { name: "StyledFooter" },
        Object(a["c"])(Dt, { shelfEnv: Boolean })([Qt])
      ),
      ne = function () {
        var n = this,
          t = n.$createElement,
        ...
        return n.isHome
          ? e(
              ...
              [
                e("NavItem", { attrs: { href: n.workURL } }, [n._v("My Work")]),
                e("NavItem", { attrs: { href: n.shelfURL } }, [
                  n._v("My Shelf"),
                ]),
                e("NavItem", { attrs: { href: n.resumeURL, external: "" } }, [
                  n._v("My Résumé"),
                ]),
              ],
              1
          ...
          : e(
              ...
              [
                e("NavItem", { attrs: { href: n.landingURL } }, [n._v("Home")]),
                n.isShelf
                  ? e("NavItem", { attrs: { href: n.workURL } }, [
                      n._v("My Work"),
                    ])
                  : e("NavItem", { attrs: { href: n.shelfURL } }, [
                      n._v("My Shelf"),
      ...
      ae = function () {
        var n = this,
          t = n.$createElement,
          e = n._self._c || t;
        return e("StyledBasicContact", { staticClass: "basic-contact" }, [
          e("span", { staticClass: "say-hello" }, [n._v("Say Hello")]),
          e(
            "ul",
            [
              e("NavItem", { attrs: { href: "mailto:hello@olaolu.dev" } }, [
                n._v("hello@olaolu.dev"),
              ]),
              e(
                "NavItem",
                {
      ...
      ce = {
        methods: {
          ...
          handleClick: function (n) {
            var t = this.href;
            if (
              (t && "#" === t.charAt(0) && n.preventDefault(),
              "function" === typeof this.clickFn && this.clickFn(n),
              this.isShelfEnv &&
                Object(C["h"])(this.$router) &&
                !this.isCmdOrCtrlKey(n) &&
                -1 !== [this.workURL, this.shelfURL, this.resumeURL].indexOf(t))
            ) {
              n.preventDefault();
              var e = new URL(t),
                r = e.pathname;
    ...
    var me = a["c"].div(fe()),
      pe = { components: { StyledBasicContact: me, NavItem: he } };
      ...
      Le = function () {
        ...
        return e(
          ...
          [
            e(
              "a",
              {
                attrs: {
                  ...
                  "aria-label":
                    "Logo, go to " + (n.isHome ? "homepage" : "shelf") + ".",
                },
              },
              [e("SauceDripLogo")],
              1
            ...
            e("button", {
              ref: "menuToggler",
              class: ["menu-toggle", { x: n.menuOpen }],
              attrs: {
                type: "button",
    ...
    var Ve = Object(a["b"])(
        ...
        $.minWidth(">medium")(Ne(), u.header.padding, u.header.padding),
        $.maxWidth("medium")(
          Re(),
          function (n) {
      ...
      Ge = {
        ...
        methods: {
          ...
          toggleMenu: function () {
            ...
            if (
              ...
              this.menuOpen && this.isMediumScreen
                ? document.body.classList.add("no-scroll")
                : document.body.classList.remove("no-scroll"),
              this.menuOpen &&
                r &&
                Object(C["k"])(150, function () {
          ...
          maybeCloseMenu: function (n) {
            if (this.menuOpen) {
              var t =
                n.target !== this.$refs.menuToggler &&
                !this.$refs.contactMenu.contains(n.target);
              switch (n.type) {
                case "keyup":
                  (-1 !== ["Escape", "Esc"].indexOf(n.key) ||
                    ("Tab" == n.key && t)) &&
                    this.closeMenu();
                  break;
                case "mouseup":
        ...
        props: {
          ...
          noMenuShadow: { type: Boolean, default: !1 },
        },
        components: {
          CrossSiteNav: oe,
          StyledHeader: Ye,
      ...
      Qe = function () {
        var n = this,
          t = n.$createElement,
          e = n._self._c || t;
        return e("StyledNewsletter", { attrs: { id: "newsletter" } }, [
          e(
            "form",
            {
              attrs: {
                ...
                target: "_blank",
                action:
                  "https://gmail.us20.list-manage.com/subscribe/post?u=04ac543f98469334c684d8753&id=df629ce71c",
              },
            },
            [
              e("Cavalier", [
                e("h2", { attrs: { slot: "heading" }, slot: "heading" }, [
                  n._v("Join the newsletter"),
                ]),
              ]),
              e(
                "div",
                ...
                [
                  ...
                  e("Button", { attrs: { type: "submit", noArrow: "" } }, [
                    n._v("Subscribe"),
                  ]),
                ],
                1
    ...
    var ir = { components: { StyledNewsletter: ar } },
      lr = ir,
      ...
      pr =
        ...
        o["a"].component("SkipLink", {
          ...
          render: function () {
            ...
            return n(
              "a",
              { attrs: { href: this.computedTo, id: "skip-link" } },
      ...
      Pr = function () {
        ...
        return e(
          ...
          [
            ...
            e("path", { attrs: { fill: "#3361C2", d: "M601.1 80.6l.1 5.2" } }),
            e("path", {
              attrs: {
                fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__b" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__b)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__d" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__d)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__f" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__f)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__h" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__h)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__j" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__j)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__l" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__l)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__n" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__n)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__p" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__p)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__r" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__r)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__t" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__t)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__v" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__v)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__x" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__x)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("clipPath", { attrs: { id: "olaolu-work-illo_svg__z" } }, [
              e("use", {
                attrs: {
            ...
            e(
              "g",
              { attrs: { "clip-path": "url(#olaolu-work-illo_svg__z)" } },
              [
                e("path", {
                  attrs: {
                    fill: "#432FC6",
            ...
            e("path", {
              attrs: { fill: "#432FC6", d: "M930 639.3h-85.8v-70.5H930v70.5z" },
            }),
            e("path", {
              attrs: { fill: "#432FC6", d: "M930 639.3h-85.8v-70.5H930v70.5z" },
            }),
            ...
            e("g", [
              e("path", {
                attrs: { fill: "#3D155F", d: "M707 25.9l33.6 33.6H707V25.9z" },
              }),
            ]),
            e("path", {
              attrs: {
            ...
            e("g", [
              ...
              e("path", {
                attrs: { fill: "#3D155F", d: "M231.3 172.3h-16.9l16.9-14.6z" },
              }),
              e("path", {
                attrs: {
    ...
    function Xr() {
      var n = Object(i["a"])([
        ...
        ";\n    background-image: url(images/lucky.jpeg);\n  }\n\n  #avatar-shapes {\n    top: -25%;\n    width: 40em;\n    z-index: -1;\n    height: 126%;\n    right: -5.4em;\n    position: absolute;\n  }\n",
      ]);
      return (
        (Xr = function () {
          return n;
    ...
    var Kr = o["a"].component("Visage", {
        render: function () {
          var n = arguments[0];
          return n(Qr, { class: "visage" }, [
            n(Or, { attrs: { id: "avatar-shapes", "data-shape": !0 } }),
            n("span", {
              class: "handsome",
              attrs: { "aria-label": "Photo of Olaolu.", role: "img" },
            }),
          ]);
        },
      }),
    ...
    function no(n) {
      for (var t = 1; t < arguments.length; t++) {
        var e = null != arguments[t] ? arguments[t] : {};
        t % 2
          ? Zr(e, !0).forEach(function (t) {
              Object(S["a"])(n, t, e[t]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(e))
          : Zr(e).forEach(function (t) {
              Object.defineProperty(
                n,
                t,
                Object.getOwnPropertyDescriptor(e, t)
    ...
    var eo = a["c"].nav(
      ...
      ro = no({}, eo, { name: "StyledNavigation" }),
      oo = o["a"].component("Navigation", {
        render: function () {
          var n = arguments[0];
          return n(ro, { attrs: { "aria-label": "Main navigation." } }, [
            n("ul", { ref: "list" }, [
              n(ao, { attrs: { name: "une", ordinal: "first" } }),
              n(ao, { attrs: { name: "deux", ordinal: "second" } }),
              n(ao, { attrs: { name: "trois", ordinal: "third" } }),
              n(ao, { attrs: { name: "quatre", ordinal: "fourth" } }),
              n(ao, { attrs: { name: "cinq", ordinal: "fifth" } }),
            ]),
          ]);
        },
      }),
      ao = o["a"].component("Bullet", {
        ...
        methods: {
          handleClick: function () {
            ...
            K(this.$store, { node: this.$root.$el.querySelector(n) });
          },
        },
        render: function () {
          var n = arguments[0],
        ...
        props: {
          name: { type: String, required: !0 },
          ordinal: { type: String, required: !0 },
        },
      });
    function io(n, t) {
      var e = Object.keys(n);
    ...
    var vo = Object(a["c"])(Dt)(
        po(),
        $.minWidth(">medium")(mo(), function (n) {
          var t = n.theme;
          return t.colors.default;
        }),
        $.minWidth(">portrait")(fo()),
        $.maxWidth("portrait")(ho()),
        $.minWidth(">medium")(uo()),
        $.between(">portrait", "medium")(co()),
        $.maxWidth("portrait")(so())
      ),
      go = lo({}, vo, { name: "StyledContact" }),
      bo = o["a"].component("Contact", {
        props: ["name"],
        render: function () {
          var n = arguments[0];
          return n(go, { attrs: { name: this.name } }, [
            n("div", { class: "inner-content" }, [
              n("Cavalier", {
                attrs: {
              ...
              n("ContactForm", { attrs: { id: "home-contact" } }),
            ]),
          ]);
        },
      }),
    ...
    function wo(n) {
      for (var t = 1; t < arguments.length; t++) {
        var e = null != arguments[t] ? arguments[t] : {};
        t % 2
          ? Mo(e, !0).forEach(function (t) {
              Object(S["a"])(n, t, e[t]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(e))
          : Mo(e).forEach(function (t) {
              Object.defineProperty(
                n,
                t,
                Object.getOwnPropertyDescriptor(e, t)
    ...
    var No = Object(C["c"])(
        "\n  90deg, "
          .concat(s.electricBlue, " 67%,\n  ")
          .concat(s.lime, " 33%\n")
      ),
      qo = Object(a["c"])(Dt)(
        Ro(),
        s.electricBlue,
        $.minWidth(">portrait")($o(), "linear-gradient(".concat(No, ")")),
        $.maxWidth("medium")(Ao()),
        $.minWidth(">medium")(Ho()),
        $.maxWidth("portrait")(Io()),
        $.maxWidth("portrait")(Do(), function (n) {
          var t = n.theme;
        ...
        $.between(">portrait", "medium")(Lo()),
        $.maxWidth("portrait")(Eo()),
        $.minWidth(">medium")(Po()),
        $.maxWidth("portrait")(Co()),
        $.minWidth(">portrait")(So()),
        $.maxWidth("portrait")(jo()),
        $.minWidth(">portrait")(ko()),
        $.maxWidth("medium")(xo()),
        function (n) {
          var t = n.theme;
      ...
      Uo = wo({}, qo, { name: "StyledPitchSlate" }),
      Vo = o["a"].component("PitchSlate", {
        ...
        render: function () {
          var n = arguments[0];
          return n(Uo, { attrs: { name: this.name } }, [
            n("div", { class: "inner-content primary" }, [
              !this.isMediumScreen &&
                n(Hr, {
                  attrs: { id: "sauce-drip-outline", "data-shape": !0 },
                }),
              n(
                "Cavalier",
                {
                ...
                [
                  n(
                    ...
                    {
                      slot: "heading",
                      attrs: { "aria-label": "Frontend Developer" },
                    },
                    [
                  ...
                  this.renderHighlights({ vocalize: !0 }),
                ]
              ),
              !this.isPortrait && n("Visage"),
            ]),
            n("div", { class: "inner-content bottom" }, [
              this.renderHighlights({ vocalize: !1 }),
              !this.isMediumScreen && n(oo, { attrs: { id: d } }),
            ]),
            this.isPortrait &&
              n("div", { class: "mobile-avatar" }, [n("Visage")]),
          ]);
        },
      }),
      Yo = Vo;
    ...
    function Jo(n) {
      for (var t = 1; t < arguments.length; t++) {
        var e = null != arguments[t] ? arguments[t] : {};
        t % 2
          ? Go(e, !0).forEach(function (t) {
              Object(S["a"])(n, t, e[t]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(e))
          : Go(e).forEach(function (t) {
              Object.defineProperty(
                n,
                t,
                Object.getOwnPropertyDescriptor(e, t)
    ...
    var ia = Object(a["c"])(Dt)(
        ...
        $.minWidth(">medium")(oa()),
        $.minWidth(">medium")(ra()),
        $.maxWidth("medium")(ea(), function (n) {
          var t = n.theme;
          return t.header.height;
        }),
        $.maxWidth("portrait")(ta()),
        $.minWidth(">medium")(na()),
        $.maxWidth("portrait")(Zo()),
        $.minWidth(">portrait")(Qo()),
        $.between(">portrait", "medium")(Ko()),
        $.minWidth(">medium")(Xo())
      ),
      la = Jo({}, ia, { name: "StyledExperience" }),
      sa = o["a"].component("Experience", {
        computed: Object(_["b"])([v]),
        render: function () {
          var n = arguments[0],
            t = "trois" === this.currentSection;
          return n(la, { attrs: { name: this.name } }, [
            n("div", { class: "inner-content" }, [
              n(
                "Cavalier",
                {
                  attrs: {
                    theme: "lime",
                    heading: "Over the <br /> past ".concat(
                ...
                [
                  ...
                  this.hireable &&
                    n("p", { slot: "text" }, [
                      "I'm now available for contracts and remote full-time roles. Want us to work together? You should",
                      " ",
                      n(
                        "a",
                        {
                          attrs: {
                            href: "mailto:hello@olaolu.dev?subject=".concat(
                              encodeURIComponent(
              ...
              n(
                "figure",
                { class: "work-illo", attrs: { "aria-hidden": !t } },
                [
                  n(Tr),
                  n("figcaption", { class: "visuallyhidden" }, [
    ...
    function da(n) {
      for (var t = 1; t < arguments.length; t++) {
        var e = null != arguments[t] ? arguments[t] : {};
        t % 2
          ? ua(e, !0).forEach(function (t) {
              Object(S["a"])(n, t, e[t]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(e))
          : ua(e).forEach(function (t) {
              Object.defineProperty(
                n,
                t,
                Object.getOwnPropertyDescriptor(e, t)
    ...
    var pa = Object(a["c"])(Dt)(
        ma(),
        $.maxWidth("medium")(fa()),
        $.maxWidth("medium")(ha())
      ),
      va = da({}, pa, { name: "StyledCornerstone" }),
      ga = o["a"].component("Cornerstone", {
        props: ["name"],
        render: function () {
          var n = arguments[0];
          return n(va, { attrs: { name: this.name } }, [
            n("div", { class: "inner-content" }, [
              n("Cavalier", { attrs: { heading: "Design" } }, [
                n("p", { slot: "text" }, [
                ...
                n(Cr, {
                  attrs: { "data-shape": !0, "aria-hidden": "true" },
                  slot: "inContent",
              ...
              n("Cavalier", { attrs: { heading: "Engineering" } }, [
                n("p", { slot: "text" }, [
    ...
    var Ca = Object(a["c"])(Dt)(
        Sa(),
        $.maxWidth("xLarge")(ja(), function (n) {
          var t = n.theme;
          return "calc(".concat(t.header.padding, " - 2em)");
        }),
        $.minWidth(">xLarge")(ka()),
        $.maxWidth("portrait")(xa()),
        $.maxWidth("portrait")(Oa()),
        function (n) {
          var t = n.theme;
          return t.header.padding;
        },
        $.minWidth(">portrait")(_a()),
        $.minWidth(">portrait")(ya()),
        $.between(">portrait", "medium")(wa())
      ),
      Pa = Ma({}, Ca, { name: "StyledCarriageway" }),
      Ea = o["a"].component("Carriageway", {
        props: ["name"],
        render: function () {
          var n = arguments[0];
          return n(Pa, { attrs: { name: this.name } }, [
            n("div", { class: "inner-content" }, [
              n("div", { class: "lanes" }, [
                n("div", { class: "lane" }, [
                  n("Cavalier", {
                  ...
                  n("Button", { attrs: { url: this.workURL } }, [
                    "See my work",
                  ]),
                ]),
                n("div", { class: "lane" }, [
                  ...
                  n("Button", { attrs: { url: this.shelfURL } }, [
                    "Read my Articles",
                  ]),
                ]),
              ]),
    ...
    var Wa,
      Ba,
      Da = o["a"].component("Homepage", {
        data: function () {
          return { touchY: null, prevTime: new Date().getTime() };
        },
        ...
        mounted: function () {
          var n = document,
            t = n.documentElement;
          this.isMediumScreen || Object(C["k"])(1, this.maybeRestoreSection),
            (this.$root.$el.dataset[v] = this.currentSection),
            ...
            t.addEventListener("wheel", this.handleMouseWheel, !1),
            t.addEventListener("mousewheel", this.handleMouseWheel, !1);
        },
        beforeDestroy: function () {
          var n = document,
            t = n.documentElement;
          window.removeEventListener("resize", this.handleResize),
            ...
            t.removeEventListener("wheel", this.handleMouseWheel, !1),
            t.removeEventListener("mousewheel", this.handleMouseWheel, !1),
        ...
        methods: {
          isSectionHidden: function (n) {
            var t = this.isMaxHeight
              ? this.currentSection !== n
              : this.getSection(n) instanceof HTMLElement &&
                !Object(C["b"])(this.getSection(n), { threshold: 0.5 });
            return String(t);
          },
          ...
          recalcSection: function () {
            ...
            this.goToSection({ node: n, smooth: !1 });
          },
          ...
          maybeRestoreSection: function () {
            ...
            this.goToSection({ focus: !1, node: this.mostVisibleSection }),
              this.currentSection !== this.firstSection &&
                this.$store.commit("headerCompact", !0);
          },
          ...
          handleTouchstart: function (n) {
            Array.isArray(n.touches) &&
              !this.isMediumScreen &&
              (this.touchY = n.touches[0].clientY);
          },
          handleTouchmove: function (n) {
            if (
              !this.isMediumScreen &&
              Array.isArray(n.changedTouches) &&
          ...
          handleMouseWheel: function (n) {
            if (!this.isMediumScreen && !this.scrollingLudicrouslyFast())
              switch (Math.sign(n.deltaY)) {
                case 1:
          ...
          maybeScrollJack: function (n) {
            if (!this.isMediumScreen && n) {
              ...
              c ||
                ...
                (r.includes(n.key)
                  ? (n.preventDefault(),
                    e() ? this.goToLastSection() : this.goToNextSection())
                  : o.includes(n.key)
                  ? (n.preventDefault(),
                    e() ? this.goToFirstSection() : this.goToPrevSection())
                  : "Home" === n.key
                  ? (n.preventDefault(), this.goToFirstSection())
                  : "End" === n.key &&
                    (n.preventDefault(), this.goToLastSection()));
            }
          },
        },
        render: function () {
          ...
          return n(
            "ContentView",
            {
              attrs: { id: "homepage", announcement: e, readAnnouncement: !0 },
            },
            [
              n(Yo, { attrs: { name: o, "aria-hidden": t(o) } }),
              n(ba, { attrs: { name: a, "aria-hidden": t(a) } }),
              n(ca, { attrs: { name: i, "aria-hidden": t(i) } }),
              n(La, { attrs: { name: l, "aria-hidden": t(l) } }),
              n(zo, { attrs: { name: s, "aria-hidden": t(s) } }),
            ]
          );
        },
      }),
      ...
      Ha = o["a"].component("App", {
        ...
        render: function () {
          var n = arguments[0];
          return n(a["a"], { attrs: { id: "app", theme: c } }, [
            n("SkipLink", { attrs: { to: "#section-nav" } }),
            n("Header", {
              attrs: {
            ...
            n(Ia),
            n("Footer", { attrs: { currentSection: this.currentSection } }),
          ]);
        },
      });
    o["a"].use(_["a"]);
